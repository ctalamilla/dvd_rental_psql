...
ALTER DOMAIN public.year OWNER TO root;
...
ALTER FUNCTION public._group_concat(text, text) OWNER TO root;
...
ALTER FUNCTION public.film_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO root;
...
ALTER FUNCTION public.film_not_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO root;
...
ALTER FUNCTION public.get_customer_balance(p_customer_id integer, p_effective_date timestamp without time zone) OWNER TO root;
...
ALTER FUNCTION public.inventory_held_by_customer(p_inventory_id integer) OWNER TO root;
...
ALTER FUNCTION public.inventory_in_stock(p_inventory_id integer) OWNER TO root;
...
ALTER FUNCTION public.last_day(timestamp without time zone) OWNER TO root;
...
ALTER FUNCTION public.last_updated() OWNER TO root;
...
ALTER FUNCTION public.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO root;
...
ALTER AGGREGATE public.group_concat(text) OWNER TO root;
...
ALTER TABLE public.actor_info OWNER TO root;
...
ALTER TABLE public.film_list OWNER TO root;
...
ALTER TABLE public.nicer_but_slower_film_list OWNER TO root;
